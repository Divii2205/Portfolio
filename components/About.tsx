...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-10 px-4 md:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="glass-effect p-8 rounded-3xl border border-white/5 relative overflow-hidden group hover:border-purple-500/30 transition-colors">
              ...
              solutions that are both functional and intuitive. <br /> <br />I
              enjoy learning through building, experimenting with new ideas, and
              contributing to open source. I value collaboration, attention to
              detail, and continuously improving my work with every project I
              take on.
            </p>
          </motion.div>
        </div>
